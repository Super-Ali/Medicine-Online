          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                  ...
                  child: Center(
                      child:
                          messages != null ? Text(messages.toString()) : null))
            ],
          ),
        )
      ],
...
Container senderMessage(
    BuildContext cntxt, String message, double width, double height) {
  return Container(
...
Row profileList(BuildContext context, String date, String time, String imgPath,
    String name, String passions, String btnTxt) {
  return Row(
    children: [
      Container(
...
Container examination(BuildContext context, String imgPath, String title,
    String date, String btnTxt) {
  return Container(
